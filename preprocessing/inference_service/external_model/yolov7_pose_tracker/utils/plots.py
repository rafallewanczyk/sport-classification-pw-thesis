...
from preprocessing.inference_service.external_model.yolov7_pose_tracker.utils.general import xywh2xyxy, xyxy2xywh
...
def plot_evolution(yaml_file='inference/hyp.finetune.yaml'):  # from utils.plots import *; plot_evolution()
