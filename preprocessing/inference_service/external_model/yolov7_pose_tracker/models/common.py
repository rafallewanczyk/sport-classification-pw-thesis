...
from preprocessing.inference_service.external_model.yolov7_pose_tracker.utils.general import non_max_suppression, make_divisible, scale_coords, increment_path, xyxy2xywh
from preprocessing.inference_service.external_model.yolov7_pose_tracker.utils.plots import color_list, plot_one_box
from preprocessing.inference_service.external_model.yolov7_pose_tracker.utils.torch_utils import time_synchronized
...
class autoShape(nn.Module):
    ...
    def forward(self, imgs, size=640, augment=False, profile=False):
        ...
        #   filename:   imgs = 'inference/samples/zidane.jpg'
